...
def refresh_market_cache():
    """Fetch all market data from external APIs and upsert into Supabase."""
    supabase = get_supabase()
    ...
    try:
        ...
        logger.error("Failed to refresh market summary: %s", e)
    ...
    try:
        ...
        with httpx.Client() as client:
            with ThreadPoolExecutor(max_workers=10) as executor:
                ...
                funds_result = [f.result() for f in futures]
        ...
        logger.error("Failed to refresh top funds: %s", e)
    ...
    try:
        ...
        logger.error("Failed to refresh currency: %s", e)
