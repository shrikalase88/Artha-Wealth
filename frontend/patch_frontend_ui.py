...
# 4. Insert Market Charts below Sector Performance
market_charts = """
...
# 5. Insert Currency Tab at the end, right before Portfolio
currency_tab = """
        {/* -------------------- TAB 4: CURRENCY -------------------- */}
        {activeTab === "currency" && (
...
content = content.replace('{/* -------------------- TAB 3: PORTFOLIO -------------------- */}', '{/* -------------------- TAB 4: PORTFOLIO -------------------- */}')
