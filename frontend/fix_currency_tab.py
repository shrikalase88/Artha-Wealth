...
# Remove the broken block at the end of the file
broken_block_idx = content.rfind("}\n\n\n        {/* -------------------- TAB 4: CURRENCY -------------------- */}")
if broken_block_idx != -1:
    content = content[:broken_block_idx + 2] # Keep the closing brace and newline
...
# Insert it right after TAB 3's block finishes, which is right before:
#       </div>
#
...
if insert_idx != -1:
    content = content[:insert_idx] + currency_tab + "\n" + content[insert_idx:]
